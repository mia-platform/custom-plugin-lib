...
/*
* streams not on response but on response.payload
* options accept `validateStatus` function (which accept by default 2xx) instead of `allowedStatusCodes`
* agent --> proxy option and allow an object to configure the proxy
* port and protocol only accepted in url
*/
class HttpClient {
