...
function getHeader(options, realRequestHeaders) {
  return Object.assign({}, realRequestHeaders || {}, options.headers || {})
}
...
Service.prototype = {
  get(path, querystring, options = {}) {
    options.headers = getHeader(options, this.requestMiaHeaders)
